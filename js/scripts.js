window.onload = () => {
    ...
    // function slideprev() {
    //     compteur--;
    //     elements.style.transition = transition2 + "ms linear";
    //     if (compteur < 0) {
    ...
    // function slideprev() {
    //     compteur--;
    //     elements2.style.transition = transition + "ms linear";
    //     if (compteur < 0) {
    //         compteur = slides2.length - 1
    //         let decal = -slideWidth2 * compteur;
